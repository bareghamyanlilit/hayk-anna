...
export function Home() {
  ...
  return (
    <div
      className={`text-center overflow-hidden  FontArTarumianBarakU  bg-[#FFFDFB]`}
    >
      {/* music button */}
      <div>
        <button
          onClick={() => setIsPlaying(!isPlaying)}
          className="fixed z-100 p-1  rounded-2xl bg-[#fffdfb2f]  right-7 top-7 w-20  h-20 flex justify-center items-center"
        >
          <Image
            src="/icon2.png"
            alt="icon1"
